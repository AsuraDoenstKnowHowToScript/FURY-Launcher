...
/// sidecar index (<c>mods/.bonfire-index.json</c>). Captured at install time from
...
public sealed class ModIndexEntry
{
    ...
    /// <summary>Local cached icon file name under <c>mods/.bonfire-cache/</c>, if downloaded.</summary>
